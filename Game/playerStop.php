    ...
    if ($_SERVER['REQUEST_METHOD'] === 'POST') {
        ...
        if ($stmt = $mysql_db->prepare($sql)) {
            ...
            if ($stmt->execute()) {
                ...
                $sqlStats = "UPDATE stats SET n_partidas_jogadas = '$param_n_partidas_jogadas', n_util_eli_duas_altern = '$param_n_util_eli_duas_altern', n_derr_parada = '$param_n_derr_parada', premio_total = '$param_premio_total' 
