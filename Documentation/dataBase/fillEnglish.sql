insert into questions_answer values
...
insert into denounce_validation values
...
truncate table denounce_validation;
truncate table questions_answer;
truncate table users;

drop table ranking; 
drop table stats;
drop table denounce_validation;
